...
static const gpio_pin sdram_pins[] = {
    {
        .gp_port   = GPIOB,
        .gp_pin    = GPIO5 | GPIO6,
    ...
    {
        .gp_port   = GPIOD,
	.gp_pin    = GPIO0 | GPIO1 | GPIO8 | GPIO9 | GPIO10 | GPIO14 | GPIO15,
        .gp_mode   = GPIO_MODE_AF,
        .gp_af     = GPIO_AF12,
        .gp_ospeed = GPIO_OSPEED_50MHZ,
    },
    {
        .gp_port   = GPIOE,
	.gp_pin    = GPIO0  | GPIO1  | GPIO7  | GPIO8  | GPIO9 | GPIO10 |
		     GPIO11 | GPIO12 | GPIO13 | GPIO14 | GPIO15,
        .gp_mode   = GPIO_MODE_AF,
        .gp_af     = GPIO_AF12,
        .gp_ospeed = GPIO_OSPEED_50MHZ,
    ...
    {
        .gp_port   = GPIOF,
	.gp_pin    = GPIO0  | GPIO1  | GPIO2  | GPIO3 | GPIO4 | GPIO5 |
		     GPIO11 | GPIO12 | GPIO13 | GPIO14 | GPIO15,
        .gp_mode   = GPIO_MODE_AF,
        .gp_af     = GPIO_AF12,
        .gp_ospeed = GPIO_OSPEED_50MHZ,
    ...
    {
        .gp_port   = GPIOG,
	.gp_pin    = GPIO0 | GPIO1 | GPIO4 | GPIO5 | GPIO8 | GPIO15,
        .gp_mode   = GPIO_MODE_AF,
        .gp_af     = GPIO_AF12,
        .gp_ospeed = GPIO_OSPEED_50MHZ,
    },
};
static const size_t sdram_pin_count = (&sdram_pins)[1] - sdram_pins;

#endif

static const struct sdram_timing timing = {
	.trcd = 2,		/* RCD Delay */
	.trp = 2,		/* RP Delay */
...
init_sdram(void)
{
    ...
    */
    ...
    gpio_init_pins(sdram_pins, sdram_pin_count);
#endif
    ...
    tr_tmp = sdram_timing((struct sdram_timing *)&timing);
    ...
    uint32_t continue_time = system_millis + 2;
    while (continue_time > system_millis)
        continue;
    ...
    for (size_t i = 0; i < (1 << 21); i++)
        ((uint32_t *)SDRAM_BASE_ADDRESS)[i] = 0;
}
